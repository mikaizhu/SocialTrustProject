...
% The greedy algorithm NEEDS to be run on the servers, otherwise it will be
% too slow..

clear all; close all; clc;
load rerun_facebookdata_X4 % load the previously saved data here
addpath('./Tools/')
...
for nn = 1 : N
    X_data(nn,:) = vec( X(1:2,:,nn) ); % Only need to take the last two rows, as it lives on a simplex...
end
